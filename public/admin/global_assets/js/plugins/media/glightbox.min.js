!function (e, t) {
    ...
    function h(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
            i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, n = e[o] = e[o] || [],
    ...
    function c(e) {
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, i = t.onElement,
            n = t.withCallback, s = t.avoidDuplicate, l = void 0 === s || s, o = t.once, r = void 0 !== o && o,
            c = t.useCapture, d = void 0 !== c && c, u = arguments.length > 2 ? arguments[2] : void 0, g = i || [];
    ...
    function H(e) {
        ...
        var t, i, n, s = b(), l = s.width, o = s.height, r = !1, a = null, h = null, c = null, f = !1, m = 1, y = 1,
            x = !1, S = !1, w = null, T = null, k = null, C = null, E = 0, A = 0, L = !1, I = !1, O = {}, P = {}, M = 0,
    ...
    var j = function () {
        ...
        function e() {
            ...
            var s = n.dragEl, l = n.toleranceX, o = void 0 === l ? 40 : l, r = n.toleranceY, a = void 0 === r ? 65 : r,
                h = n.slide, c = void 0 === h ? null : h, d = n.instance, u = void 0 === d ? null : d;
    ...
    function R(e, t, i, n) {
        ...
        "file" == u && (u = "http"), r.style.maxWidth = t.width, T(this.settings.plyr.js, "Plyr", (function () {
            ...
            if (null !== c.match(/\.(mp4|ogg|webm|mov)$/)) {
                ...
                var u = c.toLowerCase().split(".").pop(), p = {mp4: "", ogg: "", webm: ""};
            ...
            var S = M(s.settings.plyr, "config") ? s.settings.plyr.config : {}, w = new Plyr("#" + o, S);
    ...
    var U = function () {
            ...
            return n(e, [{
                ...
                key: "parseConfig", value: function (e, t) {
                    var i = this, n = r({descPosition: t.descPosition}, this.defaults);
                    if (O(e) && !A(e)) {
                        M(e, "type") || (M(e, "content") && e.content ? e.type = "inline" : M(e, "href") && (e.type = this.sourceType(e.href)));
                        var s = r(n, e);
                        return this.setSize(s, t), s
                    }
                    var l = "", o = e.getAttribute("data-glightbox"), h = e.nodeName.toLowerCase();
                    if ("a" === h && (l = e.href), "img" === h && (l = e.src), n.href = l, a(n, (function (s, l) {
                        ...
                        a(n, (function (e, t) {
                            ...
                            var s = o, l = new RegExp("s?" + t + "s?:s?(.*?)(" + u + "s?:|$)"), r = s.match(l);
                            if (r && r.length && r[1]) {
            ...
            return n(e, [{
                key: "setContent", value: function () {
                    ...
                    var n = this.instance.settings, s = this.slideConfig, l = k();
                    ...
                    var o = s.type, r = s.descPosition, a = t.querySelector(".gslide-media"),
                        h = t.querySelector(".gslide-title"), c = t.querySelector(".gslide-desc"),
                        u = t.querySelector(".gdesc-inner"), v = i, f = "gSlideTitle_" + this.index,
                ...
                key: "descriptionEvents", value: function (e, t) {
                    ...
                    c("click", {
                        onElement: n, withCallback: function (e, n) {
                            e.preventDefault();
                            var s = document.body, l = v(n, ".gslide-desc");
                            if (!l) return !1;
                            l.innerHTML = t.description, d(s, "gdesc-open");
                            var o = c("click", {
                                onElement: [s, v(l, ".gslide-description")], withCallback: function (e, n) {
        ...
        ee = document.getElementsByTagName("html")[0], te = {
            ...
            return n(e, [{
                ...
                key: "insertSlide", value: function () {
                    ...
                    var i = new J(e, this, t), n = i.getConfig(), s = r({}, n), l = i.create(),
                ...
                key: "setElements", value: function (e) {
                    ...
                    e && e.length && a(e, (function (e, n) {
                        var s = new J(e, t, n), l = s.getConfig(), o = r({}, l);
                ...
                key: "getElements", value: function () {
                    ...
                    this.elements = this.elements ? this.elements : [], !P(this.settings.elements) && L(this.settings.elements) && this.settings.elements.length && a(this.settings.elements, (function (i, n) {
                        var s = new J(i, e, n), l = s.getConfig(), o = r({}, l);
                ...
                key: "build", value: function () {
                    ...
                    var t = M(this.settings.svg, "next") ? this.settings.svg.next : "",
                        ...
                        n = M(this.settings.svg, "close") ? this.settings.svg.close : "", s = this.settings.lightboxHTML;
                ...
                key: "resize", value: function () {
                    ...
                    if ((e = e || this.activeSlide) && !g(e, "zoomed")) {
                        var t = b(), i = e.querySelector(".gvideo-wrapper"), n = e.querySelector(".gslide-image"),
                        ...
                        if (l <= 768 ? d(document.body, "glightbox-mobile") : u(document.body, "glightbox-mobile"), i || n) {
                            ...
                            if (i) {
                                var v = M(this.settings.plyr.config, "ratio") ? this.settings.plyr.config.ratio : "16:9",
                                    f = v.split(":"), p = 900, m = p / (parseInt(f[0]) / parseInt(f[1]));
                                if (m = Math.floor(m), r && (o -= s.offsetHeight), o < m && l > p) {
                                    var y = i.offsetWidth, x = i.offsetHeight, S = o / x, w = {width: y * S, height: x * S};
