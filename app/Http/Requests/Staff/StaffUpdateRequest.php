...
class StaffUpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'zh_position.required'    => __('Position (ZH)') . ' ' . __('cannot be empty!'),
            'zh_position.string'      => __('Position (ZH)') . ' ' . __('must be made of letters and numbers only!'),
            ...
            'en_position.required'    => __('Position (EN)') . ' ' . __('cannot be empty!'),
            'en_position.string'      => __('Position (EN)') . ' ' . __('must be made of letters and numbers only!'),
            ...
            'ru_position.required'    => __('Position (RU)') . ' ' . __('cannot be empty!'),
            'ru_position.string'      => __('Position (RU)') . ' ' . __('must be made of letters and numbers only!'),
