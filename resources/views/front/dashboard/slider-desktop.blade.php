<div class="slider slider__main stick-dots">
    ...
    <div class="slide">
        <div class="slide__img"><img class="img-fluid animated" src="{{ asset('storage/'.$slider->image ?? '') }}" alt="{{ $slider->translate(app()->getLocale())->title }}" data-lazy="{{ asset('storage/'.$slider->image ?? '') }}" data-animation-in="zoomInImage"/></div>
