<div class="slider slider__main stick-dots">
    ...
    <div class="slide">
        <div class="slide__img"><img class="img-fluid animated" src="{{ get_file_url($slider->image ?? '') }}" alt="{{ $slider->translate(app()->getLocale())->title }}" data-lazy="{{ get_file_url($slider->image ?? '') }}" data-animation-in="zoomInImage"/></div>
