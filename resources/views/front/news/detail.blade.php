...
@section('meta-tags')
    ...
    <meta property='og:image' content='{{ get_file_url($news->main_image) }}'/>
    ...
    <meta property='twitter:image' content='{{ get_file_url($news->main_image) }}'/>
        ...
        <section class="section__blog-detail">
            <div class="container py-0">
                ...
                <div class="row g-0 g-md-4 mt-0 mt-md-3 mb-4">
                    <div class="col-12">
                        <div class="img__wrapper"><img class="img-fluid w-100" src="{{get_file_url($news->main_image)}}" alt="{{ $news->translate(app()->getLocale())->title ?? '' }}"/></div>
                    </div>
