<nav class="navmenu mx-md-auto" id="navmenu">
    <ul class="navbar-nav align-items-lg-center ms-0 ms-md-auto mb-0">
        ...
        <li class="nav-item {{ request()->routeIs('house.index') ? 'active' : '' }}"><a class="nav-link" href="{{ route('portfolio.index') }}">{{ __('Portfolio') }}</a></li>
        ...
        <a class="btn btn-md btn-primary border-radius__30 col-11 d-flex justify-content-center d-lg-none py-2 my-3 mx-auto" href="tel:{{ setting('mobile') }}">
