...
@section('meta-tags')
    ...
    <meta property='og:image' content='{{ get_file_url($house->main_image) }}'/>
    ...
    <meta property='twitter:image' content='{{ get_file_url($house->main_image) }}'/>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card bg-transparent border-0 p-0 h-100">
                            <div class="main-slide">
                                <div class="img-slide"><a href="{{get_file_url($house->main_image)}}"
                                                          data-fancybox="gallery"><img
                                            src="{{get_file_url($house->main_image)}}"/></a></div>
                                @foreach($house->image()->get() as $gallery)
                                    <div class="img-slide">
                                        <a href="{{get_file_url($gallery->name)}}" data-fancybox="gallery">
                                            <img src="{{get_file_url($gallery->name)}}"/>
                                        </a>
                                    </div>
                                @endforeach
                            </div>
                            <div class="slider-nav d-none d-md-inline-flex">
                                <div class="img-slide"><img src="{{get_file_url($house->main_image)}}"/></div>
                                @foreach($house->image()->get() as $gallery)
                                    <div class="img-slide"><img src="{{get_file_url($gallery->name)}}"/></div>
                                @endforeach
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div class="mortgage-slide card border-0 h-100">
                                                            <div
                                                                ...
                                                                <img class="img-fluid m-auto"
                                                                     src="{{ get_file_url($mortgage->image ?? '')}}" alt="{{ $mortgage->image ?? '' }}"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    @endforeach
                                    ...
                                    <div class="swiper swiper__slider" id="facade-slider" data-slides="2"
                                        ...
                                        <div class="swiper-wrapper">
                                            @foreach($house->image('facade')->get() as $gallery)
                                                <div class="swiper-slide h-auto">
                                                    <a href="{{get_file_url($gallery->name)}}" data-fancybox="gallery2">
                                                        <img src="{{get_file_url($gallery->name)}}"/>
                                                    </a>
                                                </div>
                                            @endforeach
