                    ...
                    <section class="col-lg-9 col-md-12">
                        ...
                        <div id="housesContainer" class="position-relative h-100">
                            ...
                            <div id="loader" class="loader" style="display: none;">
                                <img src="{{ get_file_url('front/assets/loader.gif') }}" alt="Loading..."/>
                            </div>
                        </div>
...
@section('javascripts')
    ...
    <script src="{{ get_file_url('front/assets/plugins/jquery/jquery-ui.min.js') }}"></script>
    <link rel="stylesheet" href="{{ get_file_url('front/assets/plugins/jquery/jquery-ui.css') }}">
