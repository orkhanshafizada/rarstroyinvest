                    ...
                    <div class="d-lg-flex justify-content-between align-items-center">
                        ...
                        <div class="d-inline-flex d-md-flex grid__filters justify-content-between align-items-center">
                            <div class="d-flex align-items-center justify-content-between">
                                <div class="ms-0 d-lg-none"><a class="btn body__text1 text__primary fw-bold px-0"
                                                               data-bs-toggle="offcanvas" href="#offcanvasCategory"
                                                               role="button" aria-controls="offcanvasCategory"><span
                                            class="me-2">Filters</span><i class="far fa-sliders-up"></i></a></div>
                            </div>
                        ...
                        <div class="mb-3 mb-lg-0 d-none d-md-block">
                            <p class="mb-0"><span class="text-dark">{{ __('Projects found') }}:</span><span class="ms-1">{{ $totalHouses }}</span>
                            </p>
                        </div>
                    </div>
