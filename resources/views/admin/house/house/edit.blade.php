                ...
                <div class="page-header-content header-elements-lg-inline">
                    <div class="page-description d-flex">
                        <h4><a href="{{ url()->previous() }}"><i class="icon-arrow-left52 mr-2"></i></a> <span
                                class="font-weight-semibold">{{ __('House') }} </span> - @if (@$house->id)
                                {{ __('Update') }}
                            @else
                                {{ __('Create') }}
                            @endif
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form class="margin-form"
                                          action="{{ @$house->id ? route('admin.house.update',$house) : route('admin.house.store') }}"
                                                            ...
                                                            <div class="card">
                                                                <div
                                                                    ...
                                                                    <img
                                                                        ...
                                                                        src="{{ get_file_url(@$house->main_image ?? '') }}"
                                                                        alt=""
                                                                        id="output"
                                                                        style="height:250px; object-fit:contain;">
                                                                    <div
                                                                        class="card-img-actions-overlay card-img">
                                                                        <a href="{{ get_file_url(@$house->main_image ?? '') }}"
