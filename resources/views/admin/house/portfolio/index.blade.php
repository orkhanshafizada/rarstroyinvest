    ...
    <div class="content">
        <div class="card">
            <div class="card-header">
                ...
                @can('portfolio.create', 'admin')
                    <a href="{{ route('admin.portfolio.create') }}" class="btn btn-success btn-xs plus"
                       onclick="loader();"><i
                ...
                @foreach ($houses as $house)
                    <tr>
                        ...
                        <td style="display: flex;">
                            @can('portfolio.edit', 'admin')
                                <a href="{{ route('admin.portfolio.show', $house) }}"
                                   class="updateButton mr-1" title="show" onclick="loader();"><i
                                        class="icon-pencil7"></i></a>
                            @endcan
                            @can('portfolio.delete', 'admin')
                                <form action="{{ route('admin.portfolio.destroy', $house) }}" method="post"
                                      class="trashForm">
                                    @csrf
                                    @method('DELETE')
